...
public class WishInfo {
  ...
  private int contribution_amount;
    ...
    public WishInfo( String Item_Name, int Item_Price, Date WISH_DATE, int contribution_amount,int wish_id) {
        this.Item_Name = Item_Name;
        this.Item_Price = Item_Price;
        this.WISH_DATE = WISH_DATE;
        this.contribution_amount = contribution_amount;
    ...
    public WishInfo(int ITEM_ID,int User_id ) {
    ...
    public String toString() {
        return "{" + " Item_Name:" + Item_Name + ", Item_Price:" + Item_Price + ", WISH_DATE:" + WISH_DATE + ", contribution_amount:" + contribution_amount + "}";
    }
